...
import 'package:image_firebase/admin/graphAnalyticsChoice.dart';
import 'package:image_firebase/admin/teams_next.dart';
import 'package:image_firebase/admin/createTeams.dart';

class StartGraph extends StatefulWidget {
  const StartGraph({Key? key}) : super(key: key);

  @override
  State<StartGraph> createState() => _StartGraphState();
}

class _StartGraphState extends State<StartGraph> {
  String userID = "";
  String code = "";
